...
<div class="max-w-6xl mx-auto flex justify-between items-center">
    <h1 class="text-2xl font-bold text-blue-900">Manage Gift Products</h1>

    <a href="add-gift-product.php"
...
<div class="max-w-6xl mx-auto">
    <div class="overflow-x-auto bg-white shadow rounded-lg">
        <table class="w-full border-collapse">
            ...
            <tbody id="giftProductTable">
            <?php foreach ($gift_products as $p): ?>
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    <td class="p-3 flex gap-2">
                        <!-- Edit -->
                        <a href="edit-gift-product.php?id=<?= $p['id']; ?>"
                           class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm">
                            Edit
                        </a>

                        <!-- Delete -->
                        <a href="delete-gift-product.php?id=<?= $p['id']; ?>"
                           onclick="return confirm('Are you sure you want to delete this gift product?');"
...
<!-- FLOATING ADD GIFT PRODUCT BUTTON (MOBILE ONLY) -->
<a href="add-gift-product.php"
...
document.getElementById("searchInput").addEventListener("keyup", function () {
    ...
    let rows = document.querySelectorAll("#giftProductTable tr");
