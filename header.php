...
<div class="header_one w-full bg-white justify-between flex items-center border-b border-gray-300 pl-[80px] pr-[80px] h-[80px]">
    ...
    <!--login-and-register-->
    <?php if(!$isLoggedIn): ?>
    <div class="login-and-register flex gap-3 md:flex">
    ...
    <!--dashboard-buttons-->
    <?php if($isLoggedIn): ?>
    <div class="dashboard-buttons flex gap-3 md:flex">
    ...
    <div class="relative md:hidden">
      ...
      <div id="mobileNav" class="mobile-nav hidden absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
        <div class="py-2 px-3">
          <div class="mt-2 pt-2">
            ...
            <?php if($isLoggedIn): ?>
              <a href="./user/order-history.php" class="block border-t border-gray-100 px-4 py-2 text-sm text-[#001957] hover:bg-gray-100">Orders</a>
              <a href="./user/products.php" class="block border-t border-gray-100 px-4 py-2 text-sm text-[#001957] hover:bg-gray-100">Product</a>
          ...
          <!-- auth buttons -->
          <div class="mb-2 border-t border-gray-100 mt-3">
            <?php if(!$isLoggedIn): ?>
            ...
            <a href="./user/logout.php" class="block w-full text-center px-3 py-2 bg-red-500 hover:bg-red-600 text-white rounded font-semibold">Logout</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  document.addEventListener('keydown', function(e){ if(e.key === 'Escape'){ menu.classList.add('hidden'); toggle.setAttribute('aria-expanded', 'false'); } });
});
</script>
